...
class ConcreteCostForOwnerList_Model extends ModelSQLBeton{
	...
	public function __construct($dbLink){
		...
		$this->setTableName("concrete_costs_for_owner_list");
		...
		$f_header_id=new FieldSQLInt($this->getDbLink(),$this->getDbName(),$this->getTableName(),"header_id",$f_opts);
		$this->addField($f_header_id);
		//********************
