...
function VehicleScheduleList_Model(options){
	var id = 'VehicleScheduleList_Model';
	options = options || {};
	...
	options.fields.state_date_time = new FieldDateTime("state_date_time",filed_options);
	...
	options.fields.out_comment = new FieldString("out_comment",filed_options);
	...
	options.fields.phone_cel = new FieldString("phone_cel",filed_options);
		...
		VehicleScheduleList_Model.superclass.constructor.call(this,id,options);
}
