...
function MaterialFactConsumptionCorretion_Model(options){
	var id = 'MaterialFactConsumptionCorretion_Model';
	options = options || {};
	...
	options.fields.date_time_set.getValidator().setRequired(true);
