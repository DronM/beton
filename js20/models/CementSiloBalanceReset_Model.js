...
function CementSiloBalanceReset_Model(options){
	var id = 'CementSiloBalanceReset_Model';
	options = options || {};
	...
	*/
	...
	options.fields.comment_text = new FieldText("comment_text",filed_options);
		...
		CementSiloBalanceReset_Model.superclass.constructor.call(this,id,options);
}
