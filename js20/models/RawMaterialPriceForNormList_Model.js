...
function RawMaterialPriceForNormList_Model(options){
	var id = 'RawMaterialPriceForNormList_Model';
	options = options || {};
	...
	options.fields.users_ref = new FieldJSON("users_ref",filed_options);
		...
		RawMaterialPriceForNormList_Model.superclass.constructor.call(this,id,options);
}
