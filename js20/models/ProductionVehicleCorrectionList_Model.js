...
function ProductionVehicleCorrectionList_Model(options){
	var id = 'ProductionVehicleCorrectionList_Model';
	options = options || {};
	...
	var filed_options = {};
	filed_options.primaryKey = true;	
	filed_options.alias = 'Номер производства';
	filed_options.autoInc = false;	
	...
	options.fields.users_ref = new FieldJSON("users_ref",filed_options);
		...
		ProductionVehicleCorrectionList_Model.superclass.constructor.call(this,id,options);
}
