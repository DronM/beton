...
class ShipmentForDriverCostHeader_Controller extends ControllerSQL{
	public function __construct($dbLinkMaster=NULL,$dbLink=NULL){
		...
		$this->setListModelId('ShipmentForDriverCostHeader_Model');
		...
		$this->addPublicMethod($pm);
		$this->setObjectModelId('ShipmentForDriverCostHeader_Model');		
