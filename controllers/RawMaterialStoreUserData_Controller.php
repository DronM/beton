...
class RawMaterialStoreUserData_Controller extends ControllerSQL{
	public function __construct($dbLinkMaster=NULL,$dbLink=NULL){
		...
		$this->setListModelId('RawMaterialStoreUserDataList_Model');
		...
		$this->addPublicMethod($pm);
		$this->setObjectModelId('RawMaterialStoreUserDataList_Model');		
