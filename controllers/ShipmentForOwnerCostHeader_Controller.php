...
class ShipmentForOwnerCostHeader_Controller extends ControllerSQL{
	public function __construct($dbLinkMaster=NULL,$dbLink=NULL){
		...
		$this->setListModelId('ShipmentForOwnerCostHeader_Model');
		...
		$this->addPublicMethod($pm);
		$this->setObjectModelId('ShipmentForOwnerCostHeader_Model');		
