...
-- DROP FUNCTION public.ast_calls_process();

CREATE FUNCTION public.ast_calls_process()
    RETURNS trigger
    LANGUAGE 'plpgsql'
    COST 100
...
GRANT EXECUTE ON FUNCTION public.ast_calls_process() TO beton;

GRANT EXECUTE ON FUNCTION public.ast_calls_process() TO PUBLIC;
